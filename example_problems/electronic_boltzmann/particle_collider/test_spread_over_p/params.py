...
q1_partition = [15./60, 15./60, 30./60] # List of the fractional ranges of each subdomain in q1
# The above indices correspond to  x = [-4.5700, -0.0075, 26.286, 29.5287, 33.010, 50]
# TODO : Automate the indices using coords
q2_partition = [15./60, 15./60, 30./60] # List of the fractional ranges of each subdomain in q2
...
def tau_defect(q1, q2, p1, p2, p3):
    ...
    tau_mr = np.inf
    if ((q1_midpoint < 0.5) and (q1_midpoint > 0.25) and (q2_midpoint < 0.5) and (q2_midpoint > 0.25)):
        tau_mr = 0.1 
