...
filepath = \
'/home/mchandra/gitansh/gitansh_bolt/example_problems/electronic_boltzmann/L_5.0_10.0_classical_ballistic_with_internal_mirror/dumps'
...
for file_number, dump_file in yt.parallel_objects(enumerate(moment_files)):
    ...
    print("file_number = ", file_number, "density.shape = ", density.shape)
    print("file_number = ", file_number, "j_x.shape = ", j_x.shape)

    vel_drift_x = np.divide(j_x, density)
    vel_drift_y = np.divide(j_y, density)
