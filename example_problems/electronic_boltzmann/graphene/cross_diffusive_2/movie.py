...
filepath = \
'/home/mchandra/gitansh/zero_T_with_mirror/example_problems/electronic_boltzmann/graphene/cross_diffusive/dumps'
...
for file_number, dump_file in enumerate(moment_files_1[:1]):
    ...
    combined_vel_drift_x_array[q2_index:q2_index+contact_width, :vel_drift_x_1.shape[1]] = \
            vel_drift_x_1
    combined_vel_drift_x_array[:, q1_index:q1_index+contact_width] = \
            vel_drift_x_2
    combined_vel_drift_x_array[q2_index:q2_index+contact_width, q1_index+contact_width:] = \
            vel_drift_x_3

    combined_vel_drift_y_array[q2_index:q2_index+contact_width, :vel_drift_x_1.shape[1]] = \
            vel_drift_y_1
    combined_vel_drift_y_array[:, q1_index:q1_index+contact_width] = \
            vel_drift_y_2
    combined_vel_drift_y_array[q2_index:q2_index+contact_width, q1_index+contact_width:] = \
            vel_drift_y_3
    
    if (file_number == 0):
        mean_density_1 = np.mean(combined_density_array[:density_1.shape[0], q2_index:q2_index+contact_width])
        mean_density_2 = np.mean(combined_density_array[q1_index:q1_index+contact_width, :])
...
for file_number, dump_file in yt.parallel_objects(enumerate(moment_files_1[:])):
    ...
    combined_density_array[:density_1.shape[0], q2_index:q2_index+contact_width] = \
    combined_density_array[:density_1.shape[0], q2_index:q2_index+contact_width] - \
    mean_density

    combined_density_array[q1_index:q1_index+contact_width, :] = \
    combined_density_array[q1_index:q1_index+contact_width, :] - \
    mean_density

    combined_density_array[q1_index+contact_width:, q2_index:q2_index+contact_width] = \
    combined_density_array[q1_index+contact_width:, q2_index:q2_index+contact_width] - \
    mean_density
    ...
    pl.xlim([domain_1.q1_start, 2.0])#domain_1.q1_end])
    pl.ylim([domain_1.q2_start, 2.0])#domain_1.q2_end])
