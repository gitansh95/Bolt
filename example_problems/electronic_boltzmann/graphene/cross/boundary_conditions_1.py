...
def f_right(f, q1, q2, p1, p2, p3, params):
    ...
    print ("f_1 : ", f_right.shape)
    print ("f_2 : ", fermi_dirac_2.shape)
    print ('q2_index : ', q2_index, '\t', contact_width)
    print ("fermi_dirac_2 : ", fermi_dirac_2[:, N_g:2*N_g, N_g:-N_g].shape)
    print ('boundary_conditions.py : ', f_right[:, -N_g:, N_g:-N_g].shape)
