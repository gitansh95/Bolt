...
for file_number, dump_file in yt.parallel_objects(enumerate(moment_files_1[:])):
    ...
    integrated_density.append(np.sum(combined_density_array))
...
pl.legend(['Local $V_{21}(t)$', 'Measured $V_{34}(t)$'], loc=1)
...
pl.plot(time_array, integrated_density)
pl.xlabel(r'Time (ps)')
pl.savefig('images/integrated_density' + '.png')
pl.clf()
