...
system_3 = physical_system(domain_3,
...
dt_3                  = params_3.dt
t_final_3             = params_3.t_final
params_3.current_time = t0_3        = 0.0
params_3.time_step    = time_step_3 = 0
...
nls_3 = nonlinear_solver(system_3)
params_3.rank = nls_3._comm.rank
...
if (params_3.restart):
    nls_3.load_distribution_function(params_3_.restart_file)
...
density_3 = nls_3.compute_moments('density')
...
while t0_1 < t_final_1:
    ...
    if (time_step_3==0):
        params_3.collision_nonlinear_iters = 10
    else:
        params_3.collision_nonlinear_iters = params_3.collision_operator_nonlinear_iters

    dump_steps_1 = params_1.dump_steps
    dump_steps_2 = params_2.dump_steps
    dump_steps_3 = params_3.dump_steps
    ...
    if (time_step_1%params_1.dump_dist_after==0):
        ...
        nls_3.dump_distribution_function('dumps/f_3_' + file_number)
    ...
    if (time_step_1%dump_steps_1==0):
        ...
        nls_3.dump_moments('dumps/moments_3_' + file_number)
        ...
        nls_3.dump_aux_arrays([params_3.mu,
                             params_3.mu_ee,
                             params_3.T_ee,
                             params_3.vel_drift_x, params_3.vel_drift_y,
                             params_3.j_x, params_3.j_y],
                             'lagrange_multipliers',
                             'dumps/lagrange_multipliers_3_' + file_number
                            )
...
nls_3.dump_distribution_function('dumps/f_3_laststep')
