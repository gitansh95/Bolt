...
while (t0 <= t_final) and (dt > 0):
#while(abs(t0 - t_final) > 1e-12):
    ...
    # Increase dumping frequency when nearing the end of the simulation
    if (t_final - params.current_time < 5*params.dt ):
        dump_steps = 1

    dt = min(params.dt, t_final - params.current_time)

    #print ("t0/current_time/dt/t_final : ", t0, params.current_time, dt, t_final)
