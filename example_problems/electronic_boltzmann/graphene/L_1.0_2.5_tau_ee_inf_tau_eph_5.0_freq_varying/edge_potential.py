...
for index in freq:
    ...
    np.savetxt("data/edge_density_L_1.000_2.500_tau_ee_inf_tau_eph_5.0_freq_%.1f.txt"%index, \
            edge_density - mean_density)
    np.savetxt("data/q2_edge_L_1.000_2.500_tau_ee_inf_tau_eph_5.0_freq_%.1f.txt"%index, q2[sensor_1_left_indices])
    np.savetxt("data/time_L_1.000_2.500_tau_ee_inf_tau_eph_5.0_freq_%.1f.txt"%index, time_array)
