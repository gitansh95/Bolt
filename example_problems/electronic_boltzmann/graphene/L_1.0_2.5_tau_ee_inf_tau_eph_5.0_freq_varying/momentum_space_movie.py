...
filepath = \
'/home/mchandra/gitansh/gitansh_bolt/example_problems/electronic_boltzmann/L_1.0_2.5_tau_ee_inf_tau_eph_9.0_DC/dumps'
...
for index_1 in range(N):
    for index_2 in range(N):
        ...
        im = pl.plot(p2, f_at_desired_q.transpose())
