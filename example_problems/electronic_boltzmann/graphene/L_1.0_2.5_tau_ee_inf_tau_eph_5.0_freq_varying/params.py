...
horizontal_mirror_0_index = int (3*domain.N_q2/4)
mirror_0_index = int(domain.N_q1/2)
...
# Time parameters:
dt      = 0.025/2 # ps
settling_time = int(round(freq_index/3))*(100./freq_index) #~33ps

t_final = settling_time + (75./freq_index)     # ps
