...
right_dirichlet_boundary_index  = 399  # Default value is N_q1-1  
...
top_dirichlet_boundary_index    = 191 # Default value is N_q2-1
...
# Time parameters:
dt      = 0.025/100 # ps #Data before 137.5 ps is using dt = 0.025/16
t_final = 100.     # ps
