...
def f_left(f, t, q1, q2, p1, p2, p3, params):
    ...
    f0 = (1./(af.exp( (E_upper - 0.*p_x
                               - mu
                    )/(k*params.T) 
                  ) + 1.
           ))
    fermi_dirac_in = fermi_dirac_in - f0
...
def f_right(f, t, q1, q2, p1, p2, p3, params):
    ...
    fermi_dirac_out = fermi_dirac_out - f0
    ...
    if (params.contact_geometry=="straight"):
        ...
        f_right = cond*fermi_dirac_out + cond2*fermi_dirac_out + (1 - cond2)*(1 - cond)*f
