...
q1_partition = [38./195, 12./195, 15./195, 12./195, 14./195, 12./195, 15./195, 12./195, 14./195, 12./195, 39./195] # List of the fractional ranges of each subdomain in q1
# TODO : Automate the indices using coords
q2_partition = [18./156, 12./156, 15./156, 12./156, 14./156, 12./156, 15./156, 12./156, 15./156, 12./156, 19./156] # List of the fractional ranges of each subdomain in q2
...
right_dirichlet_boundary_index  = 194  # Default value is N_q1-1  
...
horizontal_boundaries    = [18, 18, 18, 18, 18, 
                            30, 30, 30, 30, 30, \
                            45, 45, 45, 45, 45, \
                            57, 57, 57, 57, 57, \
                            71, 71, 71, 71, 71, \
                            ...
                            110, 110, 110, 110, 110, \
                            125, 125, 125, 125, 125, \
                            137, 137, 137, 137, 137] # index of boundary axis along q2
horizontal_boundary_lims = [(0.1423, 0.2346), (0.35, 0.4423), (0.55, 0.6423), (0.757, 0.85), (0.9653, 1.057), \
                            (0.1423, 0.2346), (0.35, 0.4423), (0.55, 0.6423), (0.757, 0.85), (0.9653, 1.057), \
                            (0.1423, 0.2346), (0.35, 0.4423), (0.55, 0.6423), (0.757, 0.85), (0.9653, 1.057), \
                            (0.1423, 0.2346), (0.35, 0.4423), (0.55, 0.6423), (0.757, 0.85), (0.9653, 1.057), \
                            (0.1423, 0.2346), (0.35, 0.4423), (0.55, 0.6423), (0.757, 0.85), (0.9653, 1.057), \
                            (0.1423, 0.2346), (0.35, 0.4423), (0.55, 0.6423), (0.757, 0.85), (0.9653, 1.057), \
                            ...
                            (0.1423, 0.2346), (0.35, 0.4423), (0.55, 0.6423), (0.757, 0.85), (0.9653, 1.057), \
                            (0.1423, 0.2346), (0.35, 0.4423), (0.55, 0.6423), (0.757, 0.85), (0.9653, 1.057), \
                            (0.1423, 0.2346), (0.35, 0.4423), (0.55, 0.6423), (0.757, 0.85), (0.9653, 1.057)] # boundary lims along q1

vertical_boundaries    = [38, 38, 38, 38, 38, \
                          50, 50, 50, 50, 50, \
                          65, 65, 65, 65, 65, \
                          77, 77, 77, 77, 77, \
                          91, 91, 91, 91, 91, \
                          ...
                          130, 130, 130, 130, 130, \
                          144, 144, 144, 144, 144, \
                          156, 156, 156, 156, 156] # index of boundary axis along q2

vertical_boundary_lims = [(0.2961, 0.3884), (0.5038, 0.5961), (0.7038, 0.7961), (0.9115, 1.0038), (1.1115, 1.2038), \
                          (0.2961, 0.3884), (0.5038, 0.5961), (0.7038, 0.7961), (0.9115, 1.0038), (1.1115, 1.2038), \
                          (0.2961, 0.3884), (0.5038, 0.5961), (0.7038, 0.7961), (0.9115, 1.0038), (1.1115, 1.2038), \
                          (0.2961, 0.3884), (0.5038, 0.5961), (0.7038, 0.7961), (0.9115, 1.0038), (1.1115, 1.2038), \
                          (0.2961, 0.3884), (0.5038, 0.5961), (0.7038, 0.7961), (0.9115, 1.0038), (1.1115, 1.2038), \
                          (0.2961, 0.3884), (0.5038, 0.5961), (0.7038, 0.7961), (0.9115, 1.0038), (1.1115, 1.2038), \
                          ...
                          (0.2961, 0.3884), (0.5038, 0.5961), (0.7038, 0.7961), (0.9115, 1.0038), (1.1115, 1.2038), \
                          (0.2961, 0.3884), (0.5038, 0.5961), (0.7038, 0.7961), (0.9115, 1.0038), (1.1115, 1.2038), \
                          (0.2961, 0.3884), (0.5038, 0.5961), (0.7038, 0.7961), (0.9115, 1.0038), (1.1115, 1.2038)] # boundary lims along q1
...
def electric_field(q1, q2, p1, p2, p3):

    N_q1_local = q1.dims()[2]
    N_q2_local = q2.dims()[3]

    print("params.py, N_q1, N_q2 : ", N_q1_local, N_q2_local)


    # Read the electric fields and load the appropriate region
    E_x = np.loadtxt("fields/E_x_%d.txt"%rank)[_i_q1_start:_i_q1_start + int(N_q1_local), _i_q2_start:_i_q2_start + int(N_q2_local)]
    E_y = np.loadtxt("fields/E_y_%d.txt"%rank)[_i_q1_start:_i_q1_start + int(N_q1_local), _i_q2_start:_i_q2_start + int(N_q2_local)]
    print("params.py, E_x shape : ", E_x.shape)


    # Convert to af array and reshape
    E_x = af.moddims(af.from_ndarray(E_x), 1, 1, N_q1_local, N_q2_local)
    E_y = af.moddims(af.from_ndarray(E_y), 1, 1, N_q1_local, N_q2_local)

    #print("params.py, E_x.shape : ", E_x.dims())
