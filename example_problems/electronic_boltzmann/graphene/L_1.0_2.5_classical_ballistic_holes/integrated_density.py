...
moment_files = \
    np.sort(glob.glob(filepath+'/L_5.0_10.0_classical_ballistic_angular_spread/dumps/moment*.h5'))
time_array_mirror = \
    np.loadtxt(filepath+"/L_5.0_10.0_classical_ballistic_angular_spread/dump_time_array.txt")

moment_files_h = \
    np.sort(glob.glob(filepath+'/L_5.0_10.0_classical_ballistic_angular_spread_holes/dumps/moment*.h5'))
time_array_mirror_h = \
    np.loadtxt(filepath+"/L_5.0_10.0_classical_ballistic_angular_spread_holes/dump_time_array.txt")
