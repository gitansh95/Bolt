...
heights   = np.arange(0.5, 2.81, 0.1)
#heights_1 = np.arange(10.5, 20.01, 0.5)
...
for l in heights:
    ...
    np.savez_compressed("edge_data/edge_L_1.0_%.2f_tau_ee_inf_tau_eph_0.01.txt"%(l/2), left=voltage_left, right=voltage_right)
