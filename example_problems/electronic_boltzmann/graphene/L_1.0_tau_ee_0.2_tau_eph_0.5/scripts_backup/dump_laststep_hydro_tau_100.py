...
heights = np.array([10.5, 20.0])

for index in heights:
    print ('Index : ', index)

    filepath = \
    '/home/mchandra/cci_data/dumps_L_1.0_%.1f_tau_ee_0.01_tau_eph_100.0'%index
    ...
    pl.savefig('images/dump_tau_mr_100_laststep_L_1.0_%.2f_hydro.png'%q2_end)
    pl.clf()
