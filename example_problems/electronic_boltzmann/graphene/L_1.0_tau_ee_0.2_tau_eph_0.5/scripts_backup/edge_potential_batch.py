...
freq = np.arange(1.0, 100.1, 1.0)

for index in freq:
    filepath = \
    '/home/mchandra/gitansh/gitansh_bolt/example_problems/electronic_boltzmann/L_0.750_1.875_tau_ee_inf_tau_eph_5.0_freq_%.1f/dumps'%index
    ...
    np.savetxt("data/edge_density_L_0.750_1.875_tau_ee_inf_tau_eph_5.0_freq_%.1f.txt"%index, \
            edge_density - mean_density)
    np.savetxt("data/q2_edge_L_0.750_1.875_tau_ee_inf_tau_eph_5.0_freq_%.1f.txt"%index, q2[sensor_1_left_indices])
    np.savetxt("data/time_L_0.750_1.875_tau_ee_inf_tau_eph_5.0_freq_%.1f.txt"%index, time_array)
