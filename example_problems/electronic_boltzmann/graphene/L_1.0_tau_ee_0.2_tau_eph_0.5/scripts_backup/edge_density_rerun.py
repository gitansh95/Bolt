...
for l in heights:
    ...
    filepath = \
	    "dumps_ballistic_tau_inf_L_1.0_%.2f_rerun"%(l)
    ...
    np.savez_compressed("edge_data/edge_L_1.0_%.2f_tau_ee_inf_tau_eph_inf_rerun.txt"%(l/2), left=voltage_left, right=voltage_right)
