...
#tau     = np.arange(0.01, 0.091, 0.01)
tau_1   = np.arange(2.1, 10.01, 0.1)
tau_2   = np.arange(10.0, 20.01, 1.0)
#tau   = np.append(tau, tau_1)
tau   = np.append(tau_1, tau_2)
...
for index in tau:
    ...
    np.savez_compressed("edge_data/edge_L_1.0_0.25_tau_ee_inf_tau_eph_%.2f.txt"%(index), left=voltage_left, right=voltage_right)
