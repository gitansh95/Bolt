...
for index_1 in range(N):
    for index_2 in range(N):
        ...
        np.savetxt('mode_data/mode_zero_L_1.0_2.5_tau_ee_inf_%d_%d.txt'%(index_1, index_2), mode_zero_array)
        np.savetxt('mode_data/mode_one_L_1.0_2.5_tau_ee_inf_%d_%d.txt'%(index_1, index_2), mode_one_array)
        np.savetxt('mode_data/mode_others_L_1.0_2.5_tau_ee_inf_%d_%d.txt'%(index_1, index_2), mode_others_array)

#pl.plot(tau_mr, mode_zero_array, '-o', label = '$\mathrm{k = 0}$')
#pl.plot(tau_mr, mode_one_array, '-o', label = '$\mathrm{k = 1}$')
#pl.plot(tau_mr, mode_others_array,'-o', label='$\mathrm{k > 1}$')
