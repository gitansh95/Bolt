...
heights = np.arange(0.6, 0.61, 0.1)

for index in heights:
    print ('Index : ', index)

    filepath = \
    '/home/mchandra/cci_data/dumps_L_1.0_%.1f_tau_ee_inf_tau_eph_inf_vel_1e-4_high_res'%index
    ...
    pl.savefig('images/dump_tau_mr_inf_laststep_L_1.0_%.2f_high_res.png'%q2_end)
    pl.clf()
