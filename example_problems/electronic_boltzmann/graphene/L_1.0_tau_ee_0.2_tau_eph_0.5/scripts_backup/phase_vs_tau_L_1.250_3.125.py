...
for index in tau:
    filepath = \
    '/home/mchandra/cci_data/L_1.250_3.125_tau_ee_inf_tau_%.2f_vel_1e-4'%index
    ...
    np.savetxt("L_1.250_3.125/edge_density_L_1.250_3.125_tau_ee_inf_tau_eph_%.2f.txt"%index, \
            edge_density - mean_density)
    np.savetxt("L_1.250_3.125/q2_edge_L_1.250_3.125_tau_ee_inf_tau_eph_%.2f.txt"%index, q2[sensor_1_left_indices])
    np.savetxt("L_1.250_3.125/time_L_1.250_3.125_tau_ee_inf_tau_eph_%.2f.txt"%index, time_array)
