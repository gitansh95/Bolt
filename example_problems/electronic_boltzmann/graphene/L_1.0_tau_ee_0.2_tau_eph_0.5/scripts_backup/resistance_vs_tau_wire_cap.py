...
for index in tau_mr:
    ...
    filepath = 'dumps_wire_cap_tau_%.2f'%index
...
np.savetxt('tau_mr_wire_cap.txt', tau_mr)
np.savetxt('resistance_vs_tau_mr_local_wire_cap.txt', resistance_array)
np.savetxt('resistance_vs_tau_mr_nonlocal_wire_cap.txt', resistance_nonlocal_array)
