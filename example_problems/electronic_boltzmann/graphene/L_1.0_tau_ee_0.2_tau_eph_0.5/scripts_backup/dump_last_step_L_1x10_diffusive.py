...
for index in heights:
    ...
    filepath = \
    '/home/mchandra/cci_data/dumps_L_1.0_20.0_tau_ee_inf_tau_eh_%.1f_DC_diffusive'%index
    ...
    pl.savefig('images/dump_laststep_L_1.0_20.0_tau_eph_%.2f_diffusive.png'%index)
    pl.clf()
