...
tau     = np.arange(0.11, 1.291, 0.01)
#tau_1   = np.arange(1.3, 9.91, 0.1)
#tau_2   = np.arange(10.0, 100.01, 1.0)
#tau   = np.append(tau, tau_1)
...
for index in tau:
    ...
    np.savez_compressed("edge_data/edge_L_1.0_0.30_tau_ee_inf_tau_eph_%.2f.txt"%(index), left=voltage_left, right=voltage_right)
