...
for index in length:
    filepath = \
    '/home/mchandra/gitansh/gitansh_bolt/example_problems/electronic_boltzmann/L_1.0_%.1f_tau_ee_inf_tau_eph_100.00_DC/dumps'%index
    ...
    #        
            ...
            np.savetxt("data/f_vs_theta_%d_%d_L_%.1f.txt"%(index_1, index_2, index), f_at_desired_q)
