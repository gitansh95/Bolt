...
p1_start = params.initial_mu - 64.*params.boltzmann_constant*params.initial_temperature
p1_end   = params.initial_mu + 64.*params.boltzmann_constant*params.initial_temperature
N_p1     = 64
