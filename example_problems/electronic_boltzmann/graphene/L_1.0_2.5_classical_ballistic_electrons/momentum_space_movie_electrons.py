...
for index_1 in range(N):
    for index_2 in range(N):
        ...
        #pl.subplot(121)
        pl.plot(x, y, color='r', linestyle = '-', alpha = 1.0)
        ...
        pl.savefig('images/dist_func_at_a_point_e_%d_%d.png'%(index_1, index_2), transparent = True)
        pl.clf()
...
pl.savefig('images/dist_func_dump_last_step_e.png', transparent = True)
pl.clf()
