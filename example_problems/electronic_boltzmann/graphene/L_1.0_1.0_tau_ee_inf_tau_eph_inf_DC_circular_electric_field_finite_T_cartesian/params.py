...
right_dirichlet_boundary_index  = 49  # Default value is N_q1-1  
...
def electric_field(q1, q2, p1, p2, p3):
    ...
    A = 0.015 # mu = 0.015. So this results in a barrier of height 2*mu
    R = 0.2   # Radius, um
    eps = 20
    x_0 = 0.5
    y_0 = 0.5

    denom = eps*((q1-x_0)**2 + (q2-y_0)**2 - R**2)

    E_x = 2*A*eps*(q1 - x_0)/af.cosh(denom)**2
    E_y = 2*A*eps*(q2 - y_0)/af.cosh(denom)**2
