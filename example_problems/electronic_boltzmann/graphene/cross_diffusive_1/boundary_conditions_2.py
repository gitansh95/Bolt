...
def f_left(f, q1, q2, p1, p2, p3, params):
    ...
    fermi_dirac_in = af.tile(fermi_dirac_in, d0=1, d1=f.shape[1], d2=f.shape[2])

    f_left[:, :N_g, :q2_index]               = fermi_dirac_in[:, :N_g, :q2_index]
    f_left[:, :N_g, q2_index+contact_width:] = fermi_dirac_in[:, :N_g, q2_index+contact_width:]
...
def f_right(f, q1, q2, p1, p2, p3, params):
    ...
    f_right[:, -N_g:, :q2_index]               = fermi_dirac_in[:, -N_g:, :q2_index]
    f_right[:, -N_g:, q2_index+contact_width:] = fermi_dirac_in[:, -N_g:, q2_index+contact_width:]
